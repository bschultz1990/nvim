...
-- Broken right now. TODO: Change this to Ultisnips later.
...
-- TODO: Make a cool markdown preview command.
-- function mdpreview()
...
-- <leader><tab> indents your entire file.
...
-- FOLDS AND SUCH
-- <leader>fd folds everything. <leader>uf unfolds everything.
