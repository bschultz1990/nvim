...
vim.api.nvim_create_user_command('Functions',
  function ()
    Functions_dir = vim.fn.stdpath("config") .. "/lua/"
    vim.cmd("edit "..Functions_dir.."/functions.lua")
  end,
  { nargs = 0 }
  )
...
vim.api.nvim_create_user_command('Vimrc',
  function ()
    Base_dir = vim.fn.stdpath("config") .. "/lua/"
    vim.cmd("edit "..Base_dir.."/base.lua")
  end,
  { nargs = 0 }
  )
...
vim.api.nvim_create_user_command('Keymaps',
  function ()
    ...
    vim.cmd("edit "..Keymap_dir.."/keymaps.lua")
  end,
  { nargs = 0 }
  )
